...
def on_flight_start():
    ...
    time.sleep(1)
    subprocess.call(['python', '/home/pi/iot-seed-drone/flight-server/flight-scripts/open.py'])
    emit('message', 'Dropping seeds..')
    time.sleep(3)
    subprocess.call(['python', '/home/pi/iot-seed-drone/flight-server/flight-scripts/close.py'])
    time.sleep(1)
